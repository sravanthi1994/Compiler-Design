...
public class SandyTest {
    ...
    @Test
    public void testGetLinePosmine() throws IllegalCharException, IllegalNumberException {
        //input string
        String input = "he \n lost \n his \n pen;";
        //create and initialize the scanner
        Scanner scanner = new Scanner(input);
        ...
        token = scanner.nextToken();
        linePos = scanner.getLinePos(token);
        assertEquals("Scanner.getLinePos :: Invalid Line Pos", new Scanner.LinePos(1, 1), linePos);
        ...
        token = scanner.nextToken();
        linePos = scanner.getLinePos(token);
        assertEquals("Scanner.getLinePos :: Invalid Line Pos", new Scanner.LinePos(3, 4), linePos);
    }
    @Test
